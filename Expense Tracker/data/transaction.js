...
export class Transaction{
    ...
    deleteTransaction(transactionId){
        // Reload fresh storage data to reflect deleted categories immediately
        this.#loadFromStorage();
    ...
    renderSummary(){
        ...
        if(!income || !expense || !balance) return;

        income.textContent = `₱${formatCurrency(this.income)}`;
        expense.textContent = `₱${formatCurrency(this.expense)}`;
        balance.textContent = `₱${formatCurrency(this.balance)}`;
    }
